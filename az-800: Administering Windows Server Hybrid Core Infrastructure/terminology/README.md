...
|n|name|desc.|O/P|
|-|----|-----|---|
|1|administrative tmp|.admx file<br/>`%systemRoot%\policyDefinitions`|PolicyDefinitionsFolder<br/><img src="https://i.imgur.com/5OW7zFT.png">|
